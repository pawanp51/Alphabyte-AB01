...
const Feedback = () => {
    ...
    return (
    <div>
        <h1 className="text-3xl font-bold text-center text-white">Feedback Form About Candidate</h1>
        <form className="flex flex-col gap-6 bg-gray-900 rounded-md p-8 mt-8" onSubmit={handleSubmit}>
